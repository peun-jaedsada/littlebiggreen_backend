...
@section('content')
    ...
    <div class="card-box">
        ...
        <hr>
        <form class="form-horizontal" action="{{ route('activity.update',$datas->id) }}" method="POST" enctype='multipart/form-data'>
            @csrf
            @method('put')
            ...
            @include('backend._module.input.uploadfile',['input_name'=> 'picture_thumbnail','input_label'=>'Activity Thumbnail','url_picture'=>asset('upload_img/activity/'.$datas->picture_thumbnail)])
            <hr>
            ...
            @include('backend._module.input.uploadfile',['input_name'=> 'picture','input_label'=>'Activity Picture','url_picture'=>asset('upload_img/activity/'.$datas->picture)])
            @include('backend._module.input.uploadfile',['input_name'=> 'picture_sm','input_label'=>'Activity Picture Mobile','url_picture'=>asset('upload_img/activity/'.$datas->picture_sm)])
